...
fullTitle: "CHEM&131: Introduction to Organic and Biochemistry"
tabLabel: "CHEM&131"
courseKey: chem131
...
3. Work through Getting Started: Course Orientation, including the ALEKS/Office/OneDrive setup guide — both need to be done by the end of your first lab, so budget the time.
...
| Item | Details |
|---|---|
| **Course Title** | CHEM&131: Introduction to Organic and Biochemistry |
...
Like CHEM&121, this course is entirely discussion-based online — no traditional lectures. You'll work through weekly Activities from your Chemfolio in a 3-2-1 Team Discussion format and apply what you're learning in your required weekly on-campus labs. Labs involve real data collection and analysis, not cookbook steps — more on exactly how in Weekly Flow and the Grading section below.
...
| **Electronic Resources** | Canvas Learning Management System. You'll need to scan and upload multi-page PDF files to Canvas — Microsoft OneDrive or Adobe Scan are recommended.<br><br>Follow the directions in the Getting Started: Course Orientation guide, which include enabling your Clark student email and Clark Labs account to activate your free Microsoft Office 365 account. |
...
As your professor, I want to make clear my commitment to creating a welcoming and compassionate classroom culture in-person and online that supports a variety of thoughts, perspectives, and lived experiences. Healthcare occupations are founded on ethical and professional standards that are improved through the inclusion of diverse voices and perspectives. We value an inclusive environment, and harassment, bias, hate, and discrimination directed at a peer or professor will not be tolerated.

To honor these commitments, I expect that everyone — including me — will:
...
- **CLO1:** Applies the fundamental rules behind functional group reactivity and metabolic processes, including molecule acidity and isomerism, with context to physiology and pharmacology.
- **CLO2:** Demonstrates a clinical-based level of understanding of the forces between and within molecules that affect the shape and function of carbohydrates, lipids, proteins, and nucleic acids.
- **CLO3:** Displays critical thinking and analytical skill to solve contextual problems necessary in the treatment of patients as a health care professional.

These outcomes are measured through your weekly 3-2-1 Team Discussions, lab reports (Results & Analysis and Discussion & Conclusions), in-lab quizzes, and the Final TYC Project. Rubrics for each are posted in the relevant Canvas module.
...
| **Setup help** | Getting Started: Course Orientation has the Office/OneDrive setup guide — this step trips people up, so budget real time and reach out to Tech Hub if you hit an error |
