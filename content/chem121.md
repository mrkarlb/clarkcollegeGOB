...
fullTitle: "CHEM&121: Introduction to Chemistry (Pre-Health)"
tabLabel: "CHEM&121"
courseKey: chem121
...
Chemistry is the foundation of the human body itself — the foods you eat and the environment around you determines physiological impacts and outcomes at a (bio)chemical level. This course exists to build the specific chemistry reasoning health professionals actually use like dosage calculations, preparing solutions, gases, and data and information literacy – things that shows up constantly in clinical work. So, this isn't chemistry for its own sake — it's a foundation your future career gets built on.
...
| Item | Details |
|---|---|
| **What it costs** | **Chemfolio** *($19.50)* + **CHEM&121 Lab Manual** *($16.70)* (Clark Bookstore) + ALEKS (paid through your course registration). |
...
A few abbreviations come up constantly in this course. Here's what they mean, so you're not guessing the first time you see them:

| Term | What it means |
|---|---|
| 3-2-1 | Your weekly Team Discussion format — named for its posting structure (three problem areas, two areas of interest, one insight from the video key). |
| OOL | Outside Of Lecture — a separate weekly class discussion, not the 3-2-1. |
| TYC | Teach Your Community — your Final Project, replacing a final exam. |
| ALEKS | Your online adaptive homework and textbook-access platform. |
| DAC | Disability Access Center — Clark's office for accommodations. |
| Chemfolio | Your required lecture/discussion workbook — you buy this! |
| TL;DR | "Too long; didn't read" — a quick plain-language summary. Wherever you see TL;DR, that line tells you the gist before the official/detailed text below it. |

## Your First Week

1. Attend your scheduled lab session. Missing it means being dropped from the course.
2. Log into Canvas and read the announcements at the top of the course.
3. Work through Module 0, including the ALEKS/Office/OneDrive setup guide — both need to be done by the end of your first lab, so budget the time.
4. Read this syllabus, especially the Start Here box and the Course Agreements section.
5. Confirm you have both your Chemfolio and lab manual from the Clark Bookstore before class — your first 3-2-1 team post is due that Wednesday.
...
| **Location/Time** | Lab: STEM Building 222, Mo/We 2:00–3:50 PM (18405) or Mo/We 5:00–6:50 PM (18407). Lecture/discussion: online, asynchronous. |
...
> **Dr. B's Note:** *Most students who stick with the weekly rhythm and stay engaged do well. The difference isn't talent, it's showing up consistently. Give yourself a fighting chance.*

## What preparation/skills do I need for this class?

CHEM is a math class combined with a foreign language course, and we move fast. We use math conversions from day one and keep using them every week, in both discussion and lab. If your math skills need more than a light dusting-off, consider brushing up before or alongside this course — most students taking CHEM&121 find the math the hardest part, not the chemistry itself.

## What can I expect in class?

This course is entirely discussion-based online — there are no traditional lectures. Instead, you'll work through weekly Activities from your Chemfolio in a 3-2-1 Team Discussion format and apply what you're learning hands-on in your required weekly on-campus labs. Labs involve real data collection and analysis, not cookbook steps — more on exactly how in Weekly Flow and the Grading section below.

> **Dr. B's Note:** *If you've taken a science course before, don't assume this one works the same way: there are no traditional lectures, quizzes happen in person during lab, and labs are real science, not a recipe to follow. More on exactly how below.*
...
Quizzes are the one exception to this weekly pattern — they're in-person during lab, in Weeks 2, 5, 7, 9, and 10.
...
| **Help Hours** | Monday & Wednesday, 1:00–2:00 PM and 4:00–5:00 PM (1 hour before each lab section) |
...
Canvas Inbox is our channel — for everything. I don't use email during the term, so if you send a Clark email, expect it to go unanswered; message me through Canvas Inbox instead. I respond within 24 hours on weekdays.
...
- **CLO1:** Applies the fundamental rules behind atomic structure and element reactivity to predict how bonds are formed and break, with context to physiology, pharmacology, and metabolism.
- **CLO2:** Contrast the forces at play within and between molecules or ions with their emergent properties and water (hydrophilic) or fat solubility (hydrophobic) in medical or environmental contexts.
...
| Quizzes | 20% | In-person, given during lab (Weeks 2, 5, 7, 9, and 10) |
...
Note: Clark does not award C-, D+, or D- in this course — a C- does not transfer, so grading stops at a clean C, then D, then F.
...
Life happens during an academic term. I trust you know your situation and I don't need an explanation. My position is to support your learning and your success.

- All assignments remain open after the due date, losing 1% per hour until worth zero points (approximately 5 days). Assignments can still be submitted after this, but the score will be zero.
- In-person lab attendance and the Final TYC Project have no grace period.
- No due dates extend beyond the course end date.
- If something requiring a prolonged absence occurs, contact me via Canvas Inbox and let's see what solutions are possible.

## Feedback

Discussions and other work are graded within 48 hours of each due date.
...
See Your First Week, near the top of this syllabus, for the exact five things to do before anything else.
